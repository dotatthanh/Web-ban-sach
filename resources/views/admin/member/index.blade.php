...
@section('content')
    <div class="container mt-5">
        ...
        <h1 class="title-admin"><span>Danh sách</span> Nhân viên</h1>
    </div>
        ...
        <table class="table table-bordered table-striped mt-3 mb-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.member.edit', $item->id) }}" class="btn btn-warning w-25 text-white pull-left" style="margin-right: 3px;">
                            <span>Sửa</span>
                        </a>
